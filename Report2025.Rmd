...
total.dta.long <- total.dta.long.dta %>%
  mutate(Amount = Amount.x + Amount.y, Year = year) %>% #need a year variable for when data is combined
...
-   Awaiting invoices from exhibition organisers and St John's College.  I expect St John's invoice to be around £2k.
